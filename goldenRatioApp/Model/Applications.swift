...
images: [UIImage(named: "design-apple"),UIImage(named: "design-google"),UIImage(named: "design-natgeo"),UIImage(named: "design-adidas"),UIImage(named: "design-twitter"),UIImage(named: "design-pepsi"),UIImage(named: "design-firefox"),UIImage(named: "design-layout"),UIImage(named: "design-poster"),UIImage(named: "arch-parthenon"), UIImage(named: "arch-tj"),UIImage(named: "arch-pyr"),UIImage(named: "arch-notre"),UIImage(named: "arch-kairouan"),UIImage(named: "arch-borobudur"),UIImage(named: "arch-zeus"), UIImage(named: "eng-am"), UIImage(named: "eng-clock"),UIImage(named: "eng-fd"), UIImage(named: "eng-fibo"),UIImage(named: "art-monalisa"), UIImage(named: "art-bathers"), UIImage(named: "art-pm"), UIImage(named: "art-sacrament"), UIImage(named: "mus-violin"), UIImage(named: "mus-piano"),UIImage(named: "mus-shankh"), UIImage(named: "mus-notes"), UIImage(named: "fin-stock"), UIImage(named: "fin-fibo"), UIImage(named: "nat-rose"), UIImage(named: "nat-human"),UIImage(named: "nat-shell"), UIImage(named: "nat-wave"),UIImage(named: "nat-bf"),UIImage(named: "mat-t"), UIImage(named: "mat-uc")
])

let design = Applications(list: ["Apple Logo", "Google Logo", "Nat-Geo Logo", "Adidas Logo", "Twitter Logo", "Pepsi Logo", "Firefox Logo", "Website Layout", "Poster Shapes"],
images: [UIImage(named: "design-apple"),UIImage(named: "design-google"),UIImage(named: "design-natgeo"),UIImage(named: "design-adidas"),UIImage(named: "design-twitter"),UIImage(named: "design-pepsi"),UIImage(named: "design-firefox"),UIImage(named: "design-layout"),UIImage(named: "design-poster")
])

let architecture = Applications(list: ["The Parthenon","Taj Mahal","The Great Pyramid","Notre Dame","Great Mosque of Kairouan","Stupa of Borobudur","The Temple of Zeus"],
images: [UIImage(named: "arch-parthenon"), UIImage(named: "arch-tj"),UIImage(named: "arch-pyr"),UIImage(named: "arch-notre"),UIImage(named: "arch-kairouan"),UIImage(named: "arch-borobudur"),UIImage(named: "arch-zeus")])
